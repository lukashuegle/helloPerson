...
import feature_extractor_wrapper_estimation
...
feature_extractor = feature_extractor_wrapper_estimation.feature_extractor_wrapper("ft_ResNet50", BATCH_SIZE)
...
with detection_graph.as_default():
    with tf.Session(graph=detection_graph) as sess:
        while i < PRECISION:
            ...
            seconds = (endtime - start)/1000000000
            
            i+=1

            print("Took", seconds, "for 1 detection. Threading:", did_threading)
            if i != 1:
                all_time = avarage_picture_time * scanned_pictures + seconds
                scanned_pictures += 1
                avarage_picture_time = all_time / scanned_pictures
                print("Avarage =", avarage_picture_time)
...
avarage_batch_time = feature_extractor.get_avarage_batch_time()
result = 0 
count = 0
while result < avarage_batch_time:
    result += avarage_picture_time
    count += 1
print("-----------------------------------------")
print("Optimal batch size for your system is:", count)